...
void stack_print(mystd::stack<int> s)
{
  while (!s.empty())
  {
    std::cout << " " << s.top();
...
void stack_test()
{
  ...
  mystd::stack<int> s4(a, a + 5);
  mystd::stack<int> s5(d1);
  mystd::stack<int> s6(std::move(d1));
  mystd::stack<int> s7(s2);
  mystd::stack<int> s8(std::move(s2));
  mystd::stack<int> s9;
  s9 = s3;
  mystd::stack<int> s10;
  s10 = std::move(s3);
  mystd::stack<int> s11{ 1,2,3,4,5 };
  mystd::stack<int> s12;
  s12 = { 1,2,3,4,5 };
