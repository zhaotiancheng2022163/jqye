...
void deque_test()
{
  ...
  int a[] = { 1,2,3,4,5 };
  mystd::deque<int> d1;
  mystd::deque<int> d2(5);
  mystd::deque<int> d3(5, 1);
  mystd::deque<int> d4(a, a + 5);
  mystd::deque<int> d5(d2);
  mystd::deque<int> d6(std::move(d2));
  mystd::deque<int> d7;
  d7 = d3;
  mystd::deque<int> d8;
  d8 = std::move(d3);
  mystd::deque<int> d9{ 1,2,3,4,5,6,7,8,9 };
  mystd::deque<int> d10;
