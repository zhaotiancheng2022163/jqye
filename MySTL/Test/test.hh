...
mystd::vector<long> v3(arr, arr + 3);
...
#define CON_TEST_P1(con, fun, arg, len1, len2, len3)         \
  ...
  std::cout << "\n|        mystd        |";                  \
  FUN_TEST_FORMAT1(mystd::con, fun, arg, len1);              \
  FUN_TEST_FORMAT1(mystd::con, fun, arg, len2);              \
  FUN_TEST_FORMAT1(mystd::con, fun, arg, len3);    
...
#define CON_TEST_P2(con, fun, arg1, arg2, len1, len2, len3)  \
  ...
  std::cout << "\n|        mystd        |";                  \
  FUN_TEST_FORMAT2(mystd::con, fun, arg1, arg2, len1);       \
  FUN_TEST_FORMAT2(mystd::con, fun, arg1, arg2, len2);       \
  FUN_TEST_FORMAT2(mystd::con, fun, arg1, arg2, len3);    
...
#define MAP_EMPLACE_TEST(con, len1, len2, len3)              \
  ...
  std::cout << "\n|        mystd        |";                  \
  MAP_EMPLACE_DO_TEST(mystd, con, len1);                     \
  MAP_EMPLACE_DO_TEST(mystd, con, len2);                     \
  MAP_EMPLACE_DO_TEST(mystd, con, len3);
...
#define LIST_SORT_TEST(len1, len2, len3)                     \
  ...
  std::cout << "\n|        mystd        |";                  \
  LIST_SORT_DO_TEST(mystd, len1);                            \
  LIST_SORT_DO_TEST(mystd, len2);                            \
  LIST_SORT_DO_TEST(mystd, len3);
...
#define RUN_ALL_TESTS() \
  mystd::test::UnitTest::GetInstance()->Run()
